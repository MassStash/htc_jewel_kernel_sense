...
{
#ifdef HTC_IPROUTE_DEBUG
	ALOGD("[IPROUTE2]flush_update +");
#endif
...
#ifdef HTC_IPROUTE_DEBUG
	ALOGD("[IPROUTE2]iproute_modify cmd:%s",*argv);
#endif
...
#ifdef HTC_IPROUTE_DEBUG
	ALOGD("[IPROUTE2]iproute_flush_cache+");
#endif
...
#ifdef HTC_IPROUTE_DEBUG
	ALOGD("[IPROUTE2]iproute_list_or_flush+");
#endif
...
#ifdef HTC_IPROUTE_DEBUG
	ALOGD("[IPROUTE2]do_iproute cmd=%s",*argv);
#endif
